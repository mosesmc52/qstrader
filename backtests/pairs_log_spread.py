...
import pandas as pd
import pytz
from qstrader.alpha_model.pairs_log_spread import PairsLogSpreadAlphaModel
from qstrader.asset.equity import Equity
from qstrader.asset.universe.static import StaticUniverse
from qstrader.data.backtest_data_handler import BacktestDataHandler
from qstrader.data.daily_bar_csv import CSVDailyBarDataSource
from qstrader.signals.log_zscore import LogZScoreSignal
...
if __name__ == "__main__":
    ...
    zscore = LogZScoreSignal(start_dt, strategy_universe, lookback=lookback)

    signals = SignalsCollection({"zscore": zscore}, data_handler)

    alpha_model = PairsLogSpreadAlphaModel(
