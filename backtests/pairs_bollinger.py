...
import pandas as pd
import pytz
from qstrader.alpha_model.pairs_bollinger import PairsBollingerAlphaModel
...
if __name__ == "__main__":
    ...
    alpha_model = PairsBollingerAlphaModel(
        signals, lookback, entry_z, exit_z, strategy_universe, data_handler
    )
